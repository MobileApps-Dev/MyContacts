...
public class ContactAdapter1 extends RecyclerView.Adapter<ContactAdapter1.MyHolder> {
    Context context;
    ArrayList<M_Contact1> mContacts;

    public ContactAdapter1(Context context, ArrayList<M_Contact1> mContacts) {
